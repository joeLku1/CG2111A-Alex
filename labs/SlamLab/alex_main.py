...
# ARDUINO INTERFACE
from nodes.alex_arduino_receive_node import receiveThread, startArduino
...
ENABLE_SLAM_NODE = False 		# Do not enable (enabled on other system)
ENABLE_GUI_NODE = False			# Do not enable (enabled on other system)
# ENABLE_CLI_NODE = True
ENABLE_CLI_NODE = False
# ENABLE_TLS_SERVER = False
ENABLE_TLS_SERVER = True
ENABLE_ARDUINO_INTERFACE = True
...
def main():
	...
	with PubSubManager() as mgr:
		...
		if ENABLE_DEBUG_MESSAGE_MONITOR:
			...
			mgr.add_thread(target=monitorThread, name="Monitor Thread", 
